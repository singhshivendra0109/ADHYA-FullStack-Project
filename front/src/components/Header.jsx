      ...
      <div className="w-full mx-auto px-6 md:px-10 lg:px-14 xl:px-20" >
        ...
        <div className="flex items-center justify-between h-20 md:h-24 lg:h-24">
          ...
          <div className="hidden xl:flex items-center gap-4 lg:gap-6 flex-shrink-0">
            <Link to="/login"><button className="bg-white/40 border-2 border-[#2D8B8B]/10 text-[#2D8B8B] px-8 lg:px-10 py-4 lg:py-5 rounded-[20px] lg:rounded-[24px] font-black uppercase tracking-[2px] text-xs lg:text-sm hover:bg-[#2D8B8B] hover:text-white transition-all">Login</button></Link>
            <Link to="/signup"><button className="bg-[#2D8B8B] text-white px-8 lg:px-10 py-4 lg:py-5 rounded-[20px] lg:rounded-[24px] font-black uppercase tracking-[2px] text-xs lg:text-sm shadow-xl hover:bg-[#1f6666] transition-all active:scale-95">Sign Up</button></Link>
          </div>
            ...
            <nav className="flex flex-col gap-8 md:gap-12 text-center w-full">
              ...
              <div className="flex flex-col gap-4 md:gap-6 mt-8 w-full max-w-[400px] mx-auto">
                <Link to="/login" onClick={() => setIsMenuOpen(false)} className="w-full">
                  <button className="w-full py-5 md:py-7 text-[#2D8B8B] font-black border-2 border-[#2D8B8B]/20 rounded-3xl text-base uppercase">Login</button>
                </Link>
                <Link to="/signup" onClick={() => setIsMenuOpen(false)} className="w-full">
                  <button className="w-full bg-[#2D8B8B] text-white py-5 md:py-7 rounded-3xl font-black shadow-2xl text-base uppercase">Sign Up</button>
                </Link>
              </div>
            </nav>
          </div>
